...
class MediaContent extends StatelessWidget {
  ...
  final Function(List<ImageModel> selectedImages)? onSelectionDone;

  @override
  Widget build(BuildContext context) {
    bool loaderPreviousSelection = false;
  ...
  List<ImageModel> _getSelectedFolderImages(MediaController controller) {
    ...
    if (controller.selectedPath.value == MediaCategory.brands) {
      images = controller.allBrandImages
          .where((image) => image.url.isNotEmpty)
          .toList();
    } else if (controller.selectedPath.value == MediaCategory.banners) {
