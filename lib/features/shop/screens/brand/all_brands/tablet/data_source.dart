        ...
        Padding(
          ...
          child: SingleChildScrollView(
            ...
            child: Wrap(
              ...
              children: [
                Padding(padding: EdgeInsets.only(bottom: TDeviceUtils.isMobileScreen(Get.context!) ? 0 : TSizes.xs),
                ...
                Padding(padding: EdgeInsets.only(bottom: TDeviceUtils.isMobileScreen(Get.context!) ? 0 : TSizes.xs),
                  child: Chip(label: Text('Jogger'),padding: EdgeInsets.all(TSizes.xs),),)
              ],
            ),
          ),
        )
